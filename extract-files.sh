...
adb pull system/etc/CodecDSPID.csv ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
adb pull system/etc/calibration ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
adb pull system/etc/audio_effects.conf ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
...
adb pull system/etc/firmware/BCM4330B1_002.001.003.0550.0568.hcd ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
...
adb pull system/lib/hw/audio.primary.default.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
adb pull system/lib/hw/audio.a2dp.default.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
adb pull system/lib/hw/audio_policy.default.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
adb pull system/lib/hw/camera.default.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
adb pull system/lib/hw/copybit.msm7x30.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
adb pull system/lib/hw/gps.runnymede.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
adb pull system/lib/hw/gralloc.default.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
...
adb pull system/lib/hw/lights.msm7x30.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
adb pull system/lib/hw/sensors.runnymede.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
...
# All the blobs necessary for runnymede
PRODUCT_COPY_FILES += \\
